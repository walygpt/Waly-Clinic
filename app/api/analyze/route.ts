...
import { clinicalModel } from "@/lib/clinical-model" // هذا الملف يفترض وجوده في مشروعك
...
    const model = genAI.getGenerativeModel({ model: "gemini-2.5-flash" }) // **تم التعديل هنا (2.0 -> 2.5)**
...
      gemini_model: "gemini-2.5-flash", // **تم التعديل هنا (2.0 -> 2.5)**
